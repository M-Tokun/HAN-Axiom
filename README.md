...
![Discrete vs Continuous](exploratory_visualization_discrete_continuous.jpg)
*(Figure 2: Comparison between the analytical illusion of Calculus (Blue) and the discrete reality of the HAN core (Red). Note how the Red line "locks" until energy accumulates.)*

### C. The Core Equation (Step Function)
Unlike differential equations that assume continuous change, the state transition $\dot{S}$ in HAN is defined by a threshold-based step function:
...
* **`/src`**: Core implementation files.
    * `HannyaPhysicsCore_v3_4.ts`: The physics engine (TypeScript).
    * `Ritsukan_Spiral_Dissipative_v1_4.html`: The visualization tool.
* **`/docs/axioms`**: Fundamental laws and definitions.
...
To observe the engine's dynamics:
1.  Download `Ritsukan_Spiral_Dissipative_v1_4.html`.
2.  Open the file in any modern web browser.
3.  Observe the phase progression, entropy generation ($\sigma$), and fluctuation dynamics.
